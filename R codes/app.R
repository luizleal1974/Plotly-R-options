...
# ui
  ui <- fluidPage(    plotlyOutput(outputId = "PLOT_2_1"), DT::DTOutput(outputId = "TAB_2_1")    )
...
# server
  server <- function(input, output) {
            ...
            output$TAB_2_1 <- DT::renderDT({ f(x = values, tab = TRUE)   }) # PLOT WILL NOT BE SHOWN IN SHINY APP.
            }
