...
# Animais
  Animals <- c("<b>Giraffes</b>",    # NOTA: NESTE EXEMPLO É NECESSÁRIO ESTABELECER OS RECURSOS HTML NESTA ETAPA
               "<b>Orangutans</b>",
